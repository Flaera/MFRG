...
var events_talks: Dictionary = {
	...
	"4": [
		...
		["Carlos", "Ela tá certa. Vacilou feio, mano", 2], 
		...
		["Anne", "Beleza. Meu nome é Anne Gizza da Iara Bonita e Dandara.\nMeu número é...", 1]
		],
	"5": [
