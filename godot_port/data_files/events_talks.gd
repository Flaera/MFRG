...
var events_talks: Dictionary = {
	...
	"4": [
		...
		["Traficante_Armado", "Os outros ao retiva.", 1], 
		["Anne", "Oxi! Olha...", 1], 
		["bg_only", "Ela tá certa. Vacilou feio, mano", 2], 
		["Traficante_Armado", "ê quer?", 2],
		["Carlos", "ê quer?", 2],
		["Anne", "ê quer?", 1],
		["Carlos", "ê quer?", 2],
		["Carlos", "ê quer?", 2],
	...
	"7": [
		["bg_only","Carlos, o Primeiro, fala:", 1],
		["Carlos","Agora sobe de nível.",1],
		["Anne", "O que isso significa? - Pergunta Anne.",2],
		["Carlos","Que Maria te guiará a partir de agora. Ela é a Segunda e muito boa pixadora, além de ser ótima corredora nas pistas do RUA. Quanto a você parabéns por ter melhorado e nunca deixe isso te cegar. Nunca se esqueça de onde veio e quem são os seus.", 2],
		["Anne","Ahh, que fofo. Obrigada, nunca vou me esquecer das pessoas que conheci aqui na comunidade. A fama é o de menos quando se trata de ajudar a comunidade.",2],
		["Carlos","Agora você me lembrou a Terceira. Ela é a melhor gestora e pilota que já conheci, mas nunca deixou o RUA pelos campeonatos estaduais e internacionais da grande cidade.",2],
		["bg_only","Repentinamente Maria chega de carro e  fala ao abrir a porta de seu carro:",0],
		["Maria","E ai, Carlos. Essa é a novata?",1],
		["Anne","Sim, sou eu. - Fala Anne.",2],
		["Maria","Oxi! Então bora logo fazer umas pixações e correr por aí. Sou a Segunda, administro as corridas de nível 2 e realmente acompanho os pilotos do RUA que ficam comigo,…",1],
		["bg_only","A Segunda, Maria, complementa:",0],
		["Maria","Diferente de certas pessoas aqui…", 2],
		["Carlos","Até parece que não faço meu trabalho – responde Carlos.",1],
		["Maria","Claro que não faz. Não vejo tu perto de piloto nenhum.",2],
		["Carlos","Hum, tenho ocupações e não ganho o mesmo que você – fala Carlos constestando.",1],
		["Maria","Ficou brabinho, foi?",2],
		["Carlos","Não, não mesmo. Jamais. Seu ego que subiu a cabeça.",1],
		["Maria","Não, num é ego não é dever.",2],
		["Carlos","Tá. Sei – fala Carlos ao sair de cena.",1],
