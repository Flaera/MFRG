...
func _ready():
	...
	var event_name: String = "event3_char3" # Deve ser mesmo nome do node e do file
	...
	curr_car_enemy = get_node("ViewportContainer/Viewport/car_invoker_enemy/mãe-terra")
