...
func _ready():
	char_load = preload("res://assets/blender2.79_old/assets/talk_scenes/characters/moacir/06.png")
	bg = preload("res://assets/blender2.79_old/assets/talk_scenes/talk_scene_moacir/06.png") 
	...
	path_event = "res://scenes/event3_char2/event3_char2.tscn"
...
func _process(_delta):
	...
	text_char.text="DiagMoacir"+String(index)
