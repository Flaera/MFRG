...
func _ready():
	...
	var event_name: String = "event1_char3_v1" # Deve ser mesmo nome do node e do file
	...
	curr_car_enemy = $ViewportContainer/Viewport/car_invoker_enemy/empower
