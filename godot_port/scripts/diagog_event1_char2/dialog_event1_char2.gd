...
func _ready():
	...
	bg = preload("res://assets/blender2.79_old/assets/talk_scenes/backgrounds/bg_into_house_iua.png")
	...
	path_event = "res://scenes/event1_char2/event1_char2.tscn"
...
func _process(_delta):
	...
	text_char.text="DiagIua2+"+String(index)
